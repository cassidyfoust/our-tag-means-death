...
async function getAllTags() {
  ...
  const url = `https://archiveofourown.org/tags/search?commit=Search+Tags&page=${pageNumber}&tag_search%5Bcanonical%5D=&tag_search%5Bfandoms%5D=Our+Flag+Means+Death+%28TV%29&tag_search%5Bname%5D=&tag_search%5Bsort_column%5D=created_at&tag_search%5Bsort_direction%5D=asc&tag_search%5Btype%5D=Freeform`;
  const res = await axios.get(url);
  return res;
}

async function getMaxPageNumber() {
  const url = `https://archiveofourown.org/tags/search?commit=Search+Tags&page=1&tag_search%5Bcanonical%5D=&tag_search%5Bfandoms%5D=Our+Flag+Means+Death+%28TV%29&tag_search%5Bname%5D=&tag_search%5Bsort_column%5D=created_at&tag_search%5Bsort_direction%5D=asc&tag_search%5Btype%5D=Freeform`;
